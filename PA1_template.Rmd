...
#wrong plot but the principle works!
#need a data frame that contains, the intervals, the avarage steps

#xyplot(data = head(newActivityData,5000), steps~interval | dayType, screens = list("Weekend", "Weekday"), layout = c(1,2))
